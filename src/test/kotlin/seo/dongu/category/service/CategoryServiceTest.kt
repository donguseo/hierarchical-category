...
class CategoryServiceTest {
  ...
  fun `Category 이동 - leaf to root`() {
    ...
    // when
    categoryCommandService.moveCategory(leaf.id, null)
  ...
  fun `Category 이동 - 중간 node to root`() {
    ...
    // when
    categoryCommandService.moveCategory(childCategory.id, null)
  ...
  fun `Category 이동 - 중간 node to 다른 node 하위로`() {
    ...
    // when
    categoryCommandService.moveCategory(childCategory.id, target.id)
